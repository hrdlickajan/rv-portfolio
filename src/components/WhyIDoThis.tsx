    ...
    <section id="why-i-do-this" className="editorial-block editorial-block--dark py-20 md:py-32">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="animate-on-scroll" data-delay="0s">
          ...
          <h2 className="editorial-heading font-display text-4xl md:text-6xl leading-tight mb-8">
            {w.headingLine1}
            <br />
            <em>{w.headingEmphasis}</em>
          </h2>
          <p className="text-lg md:text-xl leading-relaxed opacity-90">{w.intro}</p>
        </div>

        <div className="max-w-xl space-y-6 mt-16 md:mt-24 mb-16 md:mb-24 animate-on-scroll" data-delay="0.1s">
        ...
        <div className="grid md:grid-cols-2 gap-10 md:gap-16 mt-16 md:mt-24 mb-16 md:mb-24">
          ...
          <div className="space-y-4 animate-on-scroll" data-delay="0.3s">
        ...
        <p
          className="editorial-thought text-orange-500 text-xl md:text-2xl leading-relaxed mt-16 md:mt-24 animate-on-scroll"
          data-delay="0.1s"
        >
          {w.closingFinal}
        </p>
