      ...
      <div className="relative z-10 w-full pt-40 md:pt-0">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="md:max-w-xl lg:max-w-2xl">
            <h1 className="font-display font-bold text-3xl md:text-4xl lg:text-[40px] leading-tight mb-4 md:mb-6 text-white md:text-gray-900 hero-name">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:gap-4 hero-ctas">
              <div className="flex flex-col items-center gap-2">
                ...
                <p className="text-xs text-white/75 md:text-gray-500 text-center">{t.hero.ctaNote}</p>
              </div>
              <a
                href="#your-journey"
